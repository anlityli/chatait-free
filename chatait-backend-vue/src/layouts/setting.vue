...
<template>
  ...
  >
    <div class="setting-container">
      ...
      <div v-if="false" class="setting-info">
...
import SettingMix from '@/assets/assets-setting-mix.png'
import SettingSide from '@/assets/assets-setting-side.png'
import SettingTop from '@/assets/assets-setting-top.png'

    ...
    <t-head-menu :class="menuCls" :theme="menuTheme" expand-type="popup" :value="active">
      ...
      <template #operations>
        <div class="operations-container">
          <!-- 搜索框 -->
          <search v-if="false && layout !== 'side'" :layout="layout" />
          ...
          <t-dropdown :min-column-width="120" trigger="click">
            <template #dropdown>
              <t-dropdown-menu>
                <t-dropdown-item class="operations-dropdown-container-item" @click="handleNav('/admin/reset-password')">
            ...
            <t-button class="header-user-btn" theme="default" variant="text">
              ...
              <div class="header-user-account">{{ adminStore.adminInfo.admin_name }}</div>
              <template #suffix>
...
import { useAdminStore, useSettingStore } from '@/store'

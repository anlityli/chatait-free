...
INSERT INTO `c_config` (`config_name`, `title`, `unit`, `input_type`, `options`, `value`, `type`, `sort`, `created_at`, `updated_at`) VALUES ('midjourneyProgressSize', 'midjourney整站并发任务数', '', 1, '', '2', 'midjourney', 1, 0, 0);
INSERT INTO `c_config` (`config_name`, `title`, `unit`, `input_type`, `options`, `value`, `type`, `sort`, `created_at`, `updated_at`) VALUES ('midjourneyQueueSize', 'midjourney整站排队上限', '', 1, '', '10', 'midjourney', 2, 0, 0);
